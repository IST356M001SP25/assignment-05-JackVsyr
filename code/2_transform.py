...
survey_data = pd.read_csv('/Users/jack/Downloads/IST 356/assignment-05-JackVsyr/code/survey.csv')
states_data = pd.read_csv('/Users/jack/Downloads/IST 356/assignment-05-JackVsyr/code/states.csv')

cols = []
for year in survey_data['year'].unique():
    col = pd.read_csv(f'/Users/jack/Downloads/IST 356/assignment-05-JackVsyr/code/col_{year}.csv')
    cols.append(col)
...
combined.to_csv('/Users/jack/Downloads/IST 356/assignment-05-JackVsyr/code/survey_dataset.csv', index=False)
...
annual_salary_adjusted_by_location_and_age.to_csv('/Users/jack/Downloads/IST 356/assignment-05-JackVsyr/code/annual_salary_adjusted_by_location_and_age.csv')
...
annual_salary_adjusted_by_location_and_age.to_csv('/Users/jack/Downloads/IST 356/assignment-05-JackVsyr/code/annual_salary_adjusted_by_location_and_education.csv')
